...
```
/bwflow:integrate-skill <skill-name>
```

**Examples**:
```
/bwflow:integrate-skill frontend-design
/bwflow:integrate-skill mcp-builder
```
...
>
> - Guidelines content -> Write to `bwflow/spec/{target}/doc.md`
> - Code examples -> Place in `bwflow/spec/{target}/examples/skills/<skill-name>/`
...
|----------------|-------------------|
| UI/Frontend (`frontend-design`, `web-artifacts-builder`) | `bwflow/spec/frontend/` |
| Backend/API (`mcp-builder`) | `bwflow/spec/backend/` |
| Documentation (`doc-coauthoring`, `docx`, `pdf`) | `bwflow/` or create dedicated guidelines |
| Testing (`webapp-testing`) | `bwflow/spec/frontend/` (E2E) |
...
- **Integration target**: `bwflow/spec/{target}/`
...
| Type | Path |
|------|------|
| Guidelines doc | `bwflow/spec/{target}/doc.md` (section: `skill-<name>`) |
| Code examples | `bwflow/spec/{target}/examples/skills/<name>/` |
| Index update | `bwflow/spec/{target}/index.md` |
...
```bash
/bwflow:create-command use-<skill-name> Use <skill-name> skill following project guidelines
```
...
| `doc-coauthoring` | `bwflow/` | N/A (documentation workflow only) |
