...
> **Note**: This is a **post-implementation** safety net. Ideally, read the [Pre-Implementation Checklist](bwflow/spec/guides/pre-implementation-checklist.md) **before** writing code.
...
|----------|---------|--------|
| [Pre-Implementation Checklist](bwflow/spec/guides/pre-implementation-checklist.md) | Questions before coding | **Before** writing code |
| [Code Reuse Thinking Guide](bwflow/spec/guides/code-reuse-thinking-guide.md) | Pattern recognition | During implementation |
| **`/bwflow:check-cross-layer`** (this) | Verification check | **After** implementation |
...
**Detailed Guide**: `bwflow/spec/guides/cross-layer-thinking-guide.md`
...
**Detailed Guide**: `bwflow/spec/guides/code-reuse-thinking-guide.md`
