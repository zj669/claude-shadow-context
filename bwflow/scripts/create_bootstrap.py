...
after initializing bwflow for the first time.
...
def write_task_json(task_dir: Path, developer: str, project_type: str) -> None:
    ...
    if project_type == "frontend":
        ...
        related_files = ["bwflow/spec/frontend/"]
    elif project_type == "backend":
        subtasks = [
            {"name": "Fill backend guidelines", "status": "pending"},
            {"name": "Add code examples", "status": "pending"},
        ]
        related_files = ["bwflow/spec/backend/"]
    else:  # fullstack
        subtasks = [
            {"name": "Fill backend guidelines", "status": "pending"},
            {"name": "Fill frontend guidelines", "status": "pending"},
        ...
        related_files = ["bwflow/spec/backend/", "bwflow/spec/frontend/"]
