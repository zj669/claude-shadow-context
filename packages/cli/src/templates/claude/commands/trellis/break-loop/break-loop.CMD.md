...
- [ ] Update `bwflow/spec/guides/` thinking guides
- [ ] Update `bwflow/spec/backend/` or `frontend/` docs
...
2. **Sync templates** - After updating `bwflow/spec/`, sync to `src/templates/markdown/spec/`
